...
function Header({ onToggleTheme, isLightTheme }) {
  return (
    <header>
      <div className="header-content">
        <div className="logo">
          <img src="/assets/logo.png" alt="KRILI Logo" />
        </div>
        <nav className="nav-links">
          <a href="rent-test1.html">Home</a>
          <a href="search-test1.html">Search</a>
          <a href="profile-test1.html">Profile</a>
          <a href="item-test1.html" className="active">Item</a>
...
function App() {
  ...
  return (
    <div className="App">
      <Header onToggleTheme={toggleTheme} isLightTheme={theme === "light"} />
